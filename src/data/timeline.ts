...
export const testimonials = [
  ...
  },
  {
    ...
    date: '1 year ago',
    rating: 5,
    text: "Wow! I am blown away by the quality of Mehboob’s work. He built me an extremely powerful Agentic pipeline super quickly, with tool calls and a variety of optimizations to keep the system aligned how I needed it to. I thought it would be too complex... he delivered perfectly.",
    avatar: '🚀',
  },
  {
    name: 'laurentjoly948',
...
export const stats = [
  ...
  { label: 'Happy Clients', value: 100, suffix: '+', icon: '😊' },
  { label: 'Platforms Active', value: 4, suffix: '', icon: '🌐' },
  { label: 'Years Experience', value: 7, suffix: '+', icon: '⏰' },
];
