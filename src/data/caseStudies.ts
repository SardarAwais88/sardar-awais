export interface CaseStudy {
  ...
  techStack: string[,
  {
    slug: 'edunova-data-enrichment',
    title: 'EduNova AI Data Enrichment',
    metaTitle: 'AI Data Enrichment Agent for Schools | Case Study',
    metaDescription: 'An automated AI agent built to retrieve and enrich school data from raw CSV exports.',
    category: 'Automation',
    problem: 'The client had raw, unenriched CSV data of schools and needed a system to automatically crawl and extract missing contact info.',
    solution: 'Engineered an AI agent that takes a seed list and autonomously navigates the web to retrieve precise institutional information.',
    result: 'Enriched over 10,000 records with 95% accuracy, saving hundreds of hours of manual research.',
    techStack: ['Python', 'Selenium', 'LLMs', 'Data Scraping'],
    serviceLink: '/services/automation'
  },
  {
    slug: 'omni-platform-nextjs',
    title: 'Omni Platform Development',
    metaTitle: 'Omni Platform Next.js Development | Case Study',
    metaDescription: 'Full-stack development of the Omni Platform using Next.js.',
    category: 'Full-Stack',
    problem: 'The client needed a highly performant, scalable front-end platform for their US operations.',
    solution: 'Bootstrapped and developed a complete Next.js architecture tailored for enterprise scalability.',
    result: 'Delivered a lightning-fast UI with seamless backend integration.',
    techStack: ['Next.js', 'React', 'TypeScript', 'Tailwind'],
    serviceLink: '/services/full-stack-development'
  },
  {
    slug: 'vip-bay-realty-n8n',
    title: 'VIP Bay Realty n8n Automation',
    metaTitle: 'Real Estate n8n Workflow Automation | Case Study',
    metaDescription: 'Complete workflow automation for a real estate agency using n8n.',
    category: 'Automation',
    problem: 'Real estate agents were bogged down by manual data entry and lead routing across multiple platforms.',
    solution: 'Designed and implemented comprehensive n8n workflows that connected their CRM, email, and property listing APIs seamlessly.',
    result: 'Fully automated the lead nurturing pipeline, eliminating manual entry completely.',
    techStack: ['n8n', 'Node.js', 'Webhooks', 'Real Estate APIs'],
    serviceLink: '/services/automation'
  },
  {
    slug: 'shopify-dropshipping-ai',
    title: 'Shopify Dropshipping AI Agent',
    metaTitle: 'AI Agent for High-Ticket Dropshipping | Case Study',
    metaDescription: 'An AI Agent system developed for Shopify high-ticket dropshipping automation.',
    category: 'Automation',
    problem: 'Managing high-ticket dropshipping required constant monitoring of inventory, pricing, and supplier communication.',
    solution: 'Built a custom AI agent system specifically tailored for Shopify that autonomously manages product listings and supplier syncs.',
    result: 'Automated 80% of daily store operations, allowing the client to focus solely on marketing.',
    techStack: ['Python', 'Shopify API', 'LLMs', 'Automation'],
    serviceLink: '/services/automation'
  },
  {
    slug: 'google-ads-crewai',
    title: 'Google Ads CrewAI Agent',
    metaTitle: 'CrewAI Google Ads Optimization Agent | Case Study',
    metaDescription: 'A multi-agent system built with CrewAI to optimize Google Ads campaigns.',
    category: 'Automation',
    problem: 'The client was spending too much on inefficient Google Ads and needed an intelligent system to adjust bids and ad copy dynamically.',
    solution: 'Deployed a CrewAI setup where specialized AI agents collaborate to analyze metrics via the Google Ads API and write high-converting copy.',
    result: 'Improved ROAS (Return on Ad Spend) by 25% within the first month of deployment.',
    techStack: ['Python', 'CrewAI', 'Google Ads API', 'LangChain'],
    serviceLink: '/services/automation'
  },
  {
    slug: 'secure-evidence-intake',
    title: 'Secure Evidence Intake System',
    metaTitle: 'Secure Evidence Intake System Configuration | Case Study',
    metaDescription: 'Configuration and development of a secure intake system for marketing evidence.',
    category: 'Full-Stack',
    problem: 'The organization required a highly secure, compliant environment to intake and store sensitive digital evidence.',
    solution: 'Configured and deployed a Secure Evidence Intake System with strict environment variables, encrypted transit, and role-based access.',
    result: 'Achieved full compliance with security audits and streamlined the intake process.',
    techStack: ['Linux', 'Docker', 'Security Engineering', 'Node.js'],
    serviceLink: '/services/full-stack-development'
  },
  {
    slug: 'ai-sports-influencer',
    title: 'AI Sports Influencer Automation',
    metaTitle: 'AI Sports Influencer Setup | Case Study',
    metaDescription: 'Automation setup for an AI-generated sports influencer persona.',
    category: 'Automation',
    problem: 'The client wanted to launch a fully automated AI sports influencer but lacked the technical pipeline for content generation.',
    solution: 'Built a custom automation pipeline that scrapes sports news, generates commentary via LLMs, and creates media for auto-posting.',
    result: 'The AI influencer now maintains a consistent daily posting schedule with zero manual intervention.',
    techStack: ['Python', 'LLMs', 'Social Media APIs', 'Image Generation'],
    serviceLink: '/services/automation'
  },
  {
    slug: 'local-agent-orchestra',
    title: 'Local Agent Orchestra',
    metaTitle: 'Local-First Backend System for Agents | Case Study',
    metaDescription: 'A local-first, agent-based backend system for processing natural language tasks.',
    category: 'MCP Server',
    problem: 'The client needed a privacy-focused, offline-capable AI agent orchestration system that didn't rely entirely on cloud APIs.',
    solution: 'Engineered a Local Agent Orchestra using FastAPI and CrewAI, allowing local LLMs to process tasks securely on the host machine.',
    result: 'Achieved 100% data privacy for sensitive enterprise tasks while maintaining multi-agent collaborative reasoning.',
    techStack: ['FastAPI', 'CrewAI', 'Local LLMs', 'Python'],
    serviceLink: '/services/mcp-server-development'
  },
  {
    slug: 'edengage-rl-agents',
    title: 'EdEngage Reinforcement Learning Agents',
    metaTitle: 'Multi-Agent LLM Systems for EdEngage | Case Study',
    metaDescription: 'Implementing Reinforcement Learning in Multi-Agent LLM Systems for a mathematics tutoring app.',
    category: 'RAG Chatbot',
    problem: 'A Next.js mathematics tutoring app needed its AI tutors to adapt and improve their teaching strategies based on student success rates.',
    solution: 'Integrated Reinforcement Learning (RL) into a multi-agent LLM setup, allowing the AI to dynamically adjust its prompts and hints.',
    result: 'Increased student engagement metrics by 40% and improved test scores in beta trials.',
    techStack: ['Next.js', 'Python', 'Reinforcement Learning', 'LLMs'],
    serviceLink: '/services/rag-chatbots'
  },
  {
    slug: 'instagram-post-automation',
    title: 'Instagram Post Automation',
    metaTitle: 'Instagram Post Automation Script | Case Study',
    metaDescription: 'A robust Python script for automating Instagram content publishing.',
    category: 'Automation',
    problem: 'A digital agency needed a reliable way to bulk-schedule and auto-publish hundreds of Instagram posts without using expensive SaaS tools.',
    solution: 'Developed a headless automation script that safely interacts with Instagram APIs and emulates browser actions to publish images and Reels.',
    result: 'Saved the agency over /month in software fees and automated 100% of their scheduling.',
    techStack: ['Python', 'Selenium', 'Instagram API', 'Cron'],
    serviceLink: '/services/automation'
  },
  {
    slug: 'forex-telegram-sales-agent',
    title: 'Forex Telegram Sales Agent',
    metaTitle: 'AI Sales Agent for Forex on Telegram | Case Study',
    metaDescription: 'An AI-powered Telegram bot acting as a Forex sales agent.',
    category: 'RAG Chatbot',
    problem: 'A Forex trading group was missing out on subscriptions because they couldn't manually answer leads 24/7 on Telegram.',
    solution: 'Deployed a sophisticated Telegram AI sales agent that uses RAG to answer Forex-related queries, showcase results, and close sales.',
    result: 'Converted 15% of inbound Telegram inquiries into paid subscribers autonomously.',
    techStack: ['Python', 'Telegram API', 'RAG', 'OpenAI'],
    serviceLink: '/services/rag-chatbots'
  },
  {
    slug: 'guideforge-ai-creator',
    title: 'GuideForge AI Creator',
    metaTitle: 'GuideForge AI Guide Creator Tool | Case Study',
    metaDescription: 'A Python automation tool for creating complete guides and ebooks.',
    category: 'Full-Stack',
    problem: 'The client needed a system to rapidly generate extensive, well-researched guides and ebooks for their Italian audience.',
    solution: 'Built GuideForge, a Python-based tool that structures, researches, and writes comprehensive multi-chapter books using advanced LLM prompting chains.',
    result: 'Reduced ebook production time from weeks to just hours while maintaining high editorial quality.',
    techStack: ['Python', 'LangChain', 'PDF Generation', 'LLMs'],
    serviceLink: '/services/full-stack-development'
  },
  {
    slug: 'uefn-game-ai-agents',
    title: 'UEFN Game AI Agents',
    metaTitle: 'AI Agents for UEFN Game Project | Case Study',
    metaDescription: 'Integrating AI Agents into a UEFN (Unreal Editor for Fortnite) game project.',
    category: 'Automation',
    problem: 'A game developer wanted to introduce dynamic, AI-driven NPCs into their custom Fortnite (UEFN) maps.',
    solution: 'Developed external AI agents that process game state via webhooks and return intelligent NPC dialogue and decision trees.',
    result: 'Created a highly immersive player experience with NPCs that respond dynamically to in-game actions.',
    techStack: ['Python', 'FastAPI', 'UEFN', 'Webhooks'],
    serviceLink: '/services/automation'
  },
  {
    slug: 'monte-carlo-ai',
    title: 'Monte Carlo Tree Search AI',
    metaTitle: 'MCTS AI Implementation | Case Study',
    metaDescription: 'Implementing Monte Carlo Tree Search for an advanced AI decision engine.',
    category: 'Full-Stack',
    problem: 'The client required a highly optimized decision-making algorithm (MCTS) wrapped in a scalable Flask API for their custom game.',
    solution: 'Programmed a custom Monte Carlo Tree Search algorithm in Python, heavily optimized for speed, and exposed it via a RESTful Flask service.',
    result: 'The AI consistently beat human baselines in simulations with sub-200ms response times.',
    techStack: ['Python', 'Flask', 'MCTS Algorithm', 'Math'],
    serviceLink: '/services/full-stack-development'
  },
  {
    slug: 'ubtech-robot-integration',
    title: 'UBTECH Robot Integration',
    metaTitle: 'Python Integration for UBTECH Robot | Case Study',
    metaDescription: 'A custom Python integration layer for UBTECH robotics hardware.',
    category: 'Automation',
    problem: 'A client needed to send complex programmatic commands to a UBTECH robot but lacked a high-level API wrapper.',
    solution: 'Engineered a robust Python integration library that communicates with the robot's hardware interfaces over local networking.',
    result: 'Enabled the client to write simple Python scripts to choreograph complex robotic movements and tasks.',
    techStack: ['Python', 'Robotics', 'Sockets', 'Hardware Integration'],
    serviceLink: '/services/automation'
  }
