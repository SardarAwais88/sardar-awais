...
const SYSTEM_PROMPT = `You are an expert Upwork/Fiverr negotiator and communication assistant for Sardar Awais (Cloud & AI Automation Engineer & AI Automation Expert).
