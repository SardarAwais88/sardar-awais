...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'VAPI developer for hire',
    'Retell voice agent developer',
    'Pinecone vector store developer',
    'LangChain developer',
...
const jsonLd = [
  {
    ...
    knowsAbout: ['Artificial Intelligence', 'Machine Learning', 'Voice AI', 'Full-Stack Development', 'DevOps', 'Next.js', 'MCP Servers', 'RAG Chatbots', 'Model Context Protocol'],
  },
  {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'MCP Server Development',
    description: 'Custom Model Context Protocol servers connecting APIs and databases to Claude and other LLM agents with real authentication, error handling, and rate limiting.',
    url: 'https://sardarawais.com/services/mcp-server-development',
    provider: { '@type': 'Person', name: 'Sardar Awais' },
  ...
  },
  {
    ...
    description: 'VAPI and Retell-based voice agents that answer calls 24/7, book appointments, and integrate with CRM and calendar systems.',
    url: 'https://sardarawais.com/services/ai-voice-agent-development',
    provider: { '@type': 'Person', name: 'Sardar Awais' },
    serviceType: 'AI Development',
    areaServed: 'Worldwide',
  },
  {
    ...
    description: 'AI chatbots trained on your documents with proper chunking, embeddings, Pinecone vector store, and accuracy evaluation — not just a prompt pasted into ChatGPT.',
    url: 'https://sardarawais.com/services/rag-chatbot-development',
    provider: { '@type': 'Person', name: 'Sardar Awais' },
    serviceType: 'AI Development',
    areaServed: 'Worldwide',
  },
  {
    ...
    description: 'Custom AI agent development services. We build autonomous multi-agent systems using CrewAI, LangChain, and OpenAI to automate complex business workflows.',
    url: 'https://sardarawais.com/services/ai-agent-development',
    provider: { '@type': 'Person', name: 'Sardar Awais' },
    serviceType: 'AI Development',
    areaServed: 'Worldwide',
  },
  {
    ...
    description: 'Streamline your operations with robust business workflow automation. We integrate your software stack using Make, Zapier, and custom Node.js/Python scripts.',
    url: 'https://sardarawais.com/services/business-workflow-automation',
    provider: { '@type': 'Person', name: 'Sardar Awais' },
